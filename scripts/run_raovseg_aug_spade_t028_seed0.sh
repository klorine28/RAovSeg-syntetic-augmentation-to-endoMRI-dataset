#!/bin/bash
# =============================================================================
# RAovSeg augmented training: 1c_spade (target=0.28) as augmentation, seed 0
...
# =============================================================================
#SBATCH --job-name=raov_aug_spade_t028_s0
...
#SBATCH --output=logs/raov_aug_spade_t028_s0_%j.out
#SBATCH --error=logs/raov_aug_spade_t028_s0_%j.err
