#!/bin/bash
# =============================================================================
# RAovSeg augmented training: 1c_concat synth as augmentation, seed 0
# Submit with:  sbatch scripts/run_raovseg_aug_concat_seed0.sh
# Full pipeline: preprocess (with --extra-train-dir) → train_resclass → train_attuseg → evaluate
# =============================================================================
#SBATCH --job-name=raov_aug_concat_s0
...
#SBATCH --output=logs/raov_aug_concat_s0_%j.out
#SBATCH --error=logs/raov_aug_concat_s0_%j.err
