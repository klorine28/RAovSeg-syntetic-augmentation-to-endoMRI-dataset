#!/bin/bash
# =============================================================================
# Assemble synthetic NIfTI volumes from exp2_lam05 (D1→D2 with λ_peak=0.05).
# Same conditioning as exp2 assembly: D1 masks, D1 raw for reference frame,
# ovary target intensity 0.26. Output naming D2-9XX for RAovSeg compatibility.
# Submit with:  sbatch scripts/assemble_synth_exp2_lam05.sh
# =============================================================================
#SBATCH --job-name=synth_lam05
...
#SBATCH --output=logs/synth_lam05_%j.out
#SBATCH --error=logs/synth_lam05_%j.err
...
python -m src.Generator.assemble_synthetic_volumes \
  --config src/Generator/exp2_lam05.yaml \
  --ckpt   $RUNS/exp2_lam05/ckpt/step_100000.pt \
