#!/bin/bash
# =============================================================================
# RAovSeg augmented training: 1c_spade (Option C: skip enhancement for D2-9*) as augmentation, seed 0
...
# =============================================================================
#SBATCH --job-name=raov_aug_spade_pathC_s0
...
#SBATCH --output=logs/raov_aug_spade_pathC_s0_%j.out
#SBATCH --error=logs/raov_aug_spade_pathC_s0_%j.err
