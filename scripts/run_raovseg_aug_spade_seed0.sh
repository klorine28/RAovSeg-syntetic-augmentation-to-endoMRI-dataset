#!/bin/bash
# =============================================================================
# RAovSeg augmented training: 1c_spade synth as augmentation, seed 0
...
# =============================================================================
#SBATCH --job-name=raov_aug_spade_s0
...
#SBATCH --output=logs/raov_aug_spade_s0_%j.out
#SBATCH --error=logs/raov_aug_spade_s0_%j.err
