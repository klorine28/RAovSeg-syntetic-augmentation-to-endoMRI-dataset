#!/bin/bash
# Option B: SPADE synth with ovary target intensity = 0.28 (upper edge of enhancement window)
#SBATCH --job-name=synth_spade_t028
...
#SBATCH --output=logs/synth_spade_t028_%j.out
#SBATCH --error=logs/synth_spade_t028_%j.err
...
SYNTH_DIR=/mnt/parscratch/users/$USER/synth_mri/synth_volumes/exp1c_spade_t028
