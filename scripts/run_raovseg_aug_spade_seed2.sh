#!/bin/bash
# =============================================================================
# RAovSeg augmented training: 1c_spade synth as augmentation, seed 2
# Submit with:  sbatch scripts/run_raovseg_aug_spade_seed2.sh
# Full pipeline: preprocess (with --extra-train-dir) → train_resclass → train_attuseg → evaluate
# =============================================================================
#SBATCH --job-name=raov_aug_spade_s2
...
#SBATCH --output=logs/raov_aug_spade_s2_%j.out
#SBATCH --error=logs/raov_aug_spade_s2_%j.err
