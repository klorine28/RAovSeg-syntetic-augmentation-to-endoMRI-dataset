#!/bin/bash
# =============================================================================
# lam05 synth (λ_peak=0.05) + skip enhancement for D2-9 (Option C).
# Combines the two winning Phase 2 levers. Seed 0.
# =============================================================================
#SBATCH --job-name=raov_lam05C_s0
...
#SBATCH --output=logs/raov_lam05C_s0_%j.out
#SBATCH --error=logs/raov_lam05C_s0_%j.err
