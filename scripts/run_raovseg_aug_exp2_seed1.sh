#!/bin/bash
# =============================================================================
# RAovSeg augmented training: exp2 (D1→D2 cross-domain) synth as augmentation, seed 1
# Submit with:  sbatch scripts/run_raovseg_aug_exp2_seed1.sh
# =============================================================================
#SBATCH --job-name=raov_aug_exp2_s1
...
#SBATCH --output=logs/raov_aug_exp2_s1_%j.out
#SBATCH --error=logs/raov_aug_exp2_s1_%j.err
