#!/bin/bash
# =============================================================================
# RAovSeg augmented training: 1c_spade (Option C: skip enhancement for D2-9*) as augmentation, seed 2
...
# =============================================================================
#SBATCH --job-name=raov_aug_spade_pathC_s2
...
#SBATCH --output=logs/raov_aug_spade_pathC_s2_%j.out
#SBATCH --error=logs/raov_aug_spade_pathC_s2_%j.err
...
SYNTH_DIR=/mnt/parscratch/users/$USER/synth_mri/synth_volumes/exp1c_spade
