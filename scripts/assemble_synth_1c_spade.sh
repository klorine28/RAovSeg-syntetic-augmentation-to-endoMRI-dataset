#!/bin/bash
# =============================================================================
# Stage 1: assemble 30 synthetic NIfTI volumes from 1c_spade
# Submit with:  sbatch scripts/assemble_synth_1c_spade.sh
# =============================================================================
#SBATCH --job-name=synth_spade
...
#SBATCH --output=logs/synth_spade_%j.out
#SBATCH --error=logs/synth_spade_%j.err
