#!/bin/bash
# =============================================================================
# lam50 synth + skip enhancement (Option C). Seed 1.
# =============================================================================
#SBATCH --job-name=raov_lam50C_s1
...
#SBATCH --output=logs/raov_lam50C_s1_%j.out
#SBATCH --error=logs/raov_lam50C_s1_%j.err
