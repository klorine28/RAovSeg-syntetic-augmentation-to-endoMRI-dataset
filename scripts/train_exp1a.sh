...
# Submit with:  sbatch scripts/train_exp1a.sh
# =============================================================================
#SBATCH --job-name=exp1a_concat
...
#SBATCH --output=logs/exp1a_%j.out
#SBATCH --error=logs/exp1a_%j.err
...
python -m src.Generator.train --config src/Generator/exp1a.yaml
