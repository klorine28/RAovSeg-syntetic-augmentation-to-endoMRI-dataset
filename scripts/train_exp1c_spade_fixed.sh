...
# =============================================================================
#SBATCH --job-name=exp1c_spade_fixed
...
#SBATCH --output=logs/exp1c_spade_fixed_%j.out
#SBATCH --error=logs/exp1c_spade_fixed_%j.err
...
python -m src.Generator.train --config src/Generator/exp1c_spade_fixed.yaml
