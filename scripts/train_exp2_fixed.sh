...
# =============================================================================
#SBATCH --job-name=exp2_fixed_xdomain
...
#SBATCH --output=logs/exp2_fixed_xdomain_%j.out
#SBATCH --error=logs/exp2_fixed_xdomain_%j.err
...
python -m src.Generator.train --config src/Generator/exp2_fixed.yaml
