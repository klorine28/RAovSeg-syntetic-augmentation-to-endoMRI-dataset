#!/bin/bash
# =============================================================================
# RAovSeg augmented training: 1c_spade (Option C: skip enhancement for D2-9*) as augmentation, seed 1
...
# =============================================================================
#SBATCH --job-name=raov_aug_spade_pathC_s1
...
#SBATCH --output=logs/raov_aug_spade_pathC_s1_%j.out
#SBATCH --error=logs/raov_aug_spade_pathC_s1_%j.err
