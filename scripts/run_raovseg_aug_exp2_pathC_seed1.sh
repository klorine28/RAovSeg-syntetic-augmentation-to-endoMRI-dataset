...
# Seed 1.
# Submit with:  sbatch scripts/run_raovseg_aug_exp2_pathC_seed1.sh
# =============================================================================
#SBATCH --job-name=raov_exp2C_s1
...
#SBATCH --output=logs/raov_exp2C_s1_%j.out
#SBATCH --error=logs/raov_exp2C_s1_%j.err
