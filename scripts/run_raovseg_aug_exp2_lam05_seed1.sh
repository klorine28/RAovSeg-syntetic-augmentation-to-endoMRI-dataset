#!/bin/bash
# =============================================================================
# RAovSeg augmented training: exp2_lam05 (D1→D2 λ=0.05) synth as aug, seed 1
# Submit with:  sbatch scripts/run_raovseg_aug_exp2_lam05_seed1.sh
# =============================================================================
#SBATCH --job-name=raov_aug_lam05_s1
...
#SBATCH --output=logs/raov_aug_lam05_s1_%j.out
#SBATCH --error=logs/raov_aug_lam05_s1_%j.err
