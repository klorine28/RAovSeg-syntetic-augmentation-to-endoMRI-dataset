#!/bin/bash
# =============================================================================
# RAovSeg augmented training: 1c_spade synth as augmentation, seed 6 (variance study)
# Submit with:  sbatch scripts/run_raovseg_aug_spade_seed6.sh
# Full pipeline: preprocess (with --extra-train-dir) → train_resclass → train_attuseg → evaluate
# =============================================================================
#SBATCH --job-name=raov_aug_spade_s6
...
#SBATCH --output=logs/raov_aug_spade_s6_%j.out
#SBATCH --error=logs/raov_aug_spade_s6_%j.err
