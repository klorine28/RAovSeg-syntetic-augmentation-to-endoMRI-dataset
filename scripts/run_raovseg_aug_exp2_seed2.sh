#!/bin/bash
# =============================================================================
# RAovSeg augmented training: exp2 (D1→D2 cross-domain) synth as augmentation, seed 2
# Submit with:  sbatch scripts/run_raovseg_aug_exp2_seed2.sh
# =============================================================================
#SBATCH --job-name=raov_aug_exp2_s2
...
#SBATCH --output=logs/raov_aug_exp2_s2_%j.out
#SBATCH --error=logs/raov_aug_exp2_s2_%j.err
