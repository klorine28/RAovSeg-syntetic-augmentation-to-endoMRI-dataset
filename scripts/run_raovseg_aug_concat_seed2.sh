#!/bin/bash
# =============================================================================
# RAovSeg augmented training: 1c_concat synth as augmentation, seed 2
# Submit with:  sbatch scripts/run_raovseg_aug_concat_seed2.sh
# Full pipeline: preprocess (with --extra-train-dir) → train_resclass → train_attuseg → evaluate
# =============================================================================
#SBATCH --job-name=raov_aug_concat_s2
...
#SBATCH --output=logs/raov_aug_concat_s2_%j.out
#SBATCH --error=logs/raov_aug_concat_s2_%j.err
...
SYNTH_DIR=/mnt/parscratch/users/$USER/synth_mri/synth_volumes/exp1c_${VARIANT}
...
# --- Stage 1: preprocess (real D2 + synth from 1c_concat → train_val; 8 sacred D2 → test) ---
echo ">>> [1/4] preprocess"
