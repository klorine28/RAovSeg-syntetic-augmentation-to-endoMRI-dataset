#!/bin/bash
# =============================================================================
# RAovSeg augmented training: exp2 synth with enhancement SKIPPED (Option C).
# Seed 2.
# Submit with:  sbatch scripts/run_raovseg_aug_exp2_pathC_seed2.sh
# =============================================================================
#SBATCH --job-name=raov_exp2C_s2
...
#SBATCH --output=logs/raov_exp2C_s2_%j.out
#SBATCH --error=logs/raov_exp2C_s2_%j.err
