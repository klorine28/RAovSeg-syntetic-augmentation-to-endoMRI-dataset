#!/bin/bash
# =============================================================================
# RAovSeg augmented training: exp2 (D1→D2 cross-domain) synth as augmentation, seed 0
# Submit with:  sbatch scripts/run_raovseg_aug_exp2_seed0.sh
# Full pipeline: preprocess (with --extra-train-dir) → train_resclass → train_attuseg → evaluate
# =============================================================================
#SBATCH --job-name=raov_aug_exp2_s0
...
#SBATCH --output=logs/raov_aug_exp2_s0_%j.out
#SBATCH --error=logs/raov_aug_exp2_s0_%j.err
