#!/bin/bash
# =============================================================================
# lam50 synth (λ_peak=0.5) + skip enhancement (Option C). Seed 0.
# =============================================================================
#SBATCH --job-name=raov_lam50C_s0
...
#SBATCH --output=logs/raov_lam50C_s0_%j.out
#SBATCH --error=logs/raov_lam50C_s0_%j.err
