...
# =============================================================================
#SBATCH --job-name=exp2_lam50_fixed
...
#SBATCH --output=logs/exp2_lam50_fixed_%j.out
#SBATCH --error=logs/exp2_lam50_fixed_%j.err
...
python -m src.Generator.train --config src/Generator/exp2_lam50_fixed.yaml
