#!/bin/bash
# =============================================================================
# RAovSeg augmented training: 1c_spade synth as augmentation, seed 1
# Submit with:  sbatch scripts/run_raovseg_aug_spade_seed1.sh
# Full pipeline: preprocess (with --extra-train-dir) → train_resclass → train_attuseg → evaluate
# =============================================================================
#SBATCH --job-name=raov_aug_spade_s1
...
#SBATCH --output=logs/raov_aug_spade_s1_%j.out
#SBATCH --error=logs/raov_aug_spade_s1_%j.err
