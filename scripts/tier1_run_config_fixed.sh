...
#SBATCH --output=logs/tier1_fixed_%j.out
#SBATCH --error=logs/tier1_fixed_%j.err
...
CKPT_PATH=/mnt/parscratch/users/$USER/synth_mri/runs/exp1c_spade_fixed/ckpt/step_100000.pt
...
SWEEP_ROOT=/mnt/parscratch/users/$USER/synth_mri/sweep/tier1_fixed
