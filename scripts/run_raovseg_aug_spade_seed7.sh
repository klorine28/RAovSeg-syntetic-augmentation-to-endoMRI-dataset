#!/bin/bash
# =============================================================================
# RAovSeg augmented training: 1c_spade synth as augmentation, seed 7 (variance study)
# Submit with:  sbatch scripts/run_raovseg_aug_spade_seed7.sh
# Full pipeline: preprocess (with --extra-train-dir) → train_resclass → train_attuseg → evaluate
# =============================================================================
#SBATCH --job-name=raov_aug_spade_s7
...
#SBATCH --output=logs/raov_aug_spade_s7_%j.out
#SBATCH --error=logs/raov_aug_spade_s7_%j.err
