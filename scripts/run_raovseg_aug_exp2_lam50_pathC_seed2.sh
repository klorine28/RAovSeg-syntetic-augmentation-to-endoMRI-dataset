#!/bin/bash
# =============================================================================
# lam50 synth + skip enhancement (Option C). Seed 2.
# =============================================================================
#SBATCH --job-name=raov_lam50C_s2
...
#SBATCH --output=logs/raov_lam50C_s2_%j.out
#SBATCH --error=logs/raov_lam50C_s2_%j.err
